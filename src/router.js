...
const router = createBrowserRouter([
    ...
    {path:'/posts/:id', element:<PostDetailsPage/>, loader: ({params: {id}}) => postDetailsService.getPostById(id), children: [
            {path: '/posts/:id/comments', element: <CommentPage/>, loader: () => commentService.getComments()}
        ]}
